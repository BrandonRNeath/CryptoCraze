...
import com.nemesisprotocol.cryptocraze.domain.transaction_history.usecase.AddTransactionRecordUseCase
import com.nemesisprotocol.cryptocraze.domain.transaction_history.usecase.DeleteTransactionRecordUseCase
import com.nemesisprotocol.cryptocraze.domain.transaction_history.usecase.GetTransactionRecordsUseCase
...
class CryptoTransactionViewModel @Inject constructor(
    ...
    fun deleteTransactionRecord(transactionRecord: TransactionRecord) {
        viewModelScope.launch(dispatcherProvider.io) {
            deleteTransactionRecordUseCase(transactionRecord = transactionRecord)
        }
    }
}
